...
if __name__ == "__main__":
    with warnings.catch_warnings():
        ...
        folder = "Personal Projects/Audio_to_Text_with_LLM_Editing"

        # Combine the folder path with the recordings and text files
        # recordings = os.path.join(folder, "Recordings") #path to audio file
        recordings = os.path.join(os.path.dirname(__file__), "Recordings")
        # recording_titles = os.listdir(recordings)
        recording_text_files = os.path.join(os.path.dirname(__file__), "Recording_text_files") #path to save text files
        recording_grammar_file_path = os.path.join(os.path.dirname(__file__),"Recording_docx_files_grammar_edits") #path to save corrected .docx files
        recording_ai_file_path = os.path.join(os.path.dirname(__file__),"Recording_docx_files_AI_edits") #path to save AI corrected .docx files
